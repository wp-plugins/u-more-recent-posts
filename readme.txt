...
Demos:
http://urlless.com/u-more-recent-posts-demos/

If anything does not work please leave a comment at:
http://urlless.com/u-more-recent-posts/

== Installation ==

1. Upload <code>u-more-recent-posts</code> to the <code>/wp-content/plugins</code> directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Now you can go to 'Widgets' menu and you'll find a new widget available: "U More Recent Posts"
